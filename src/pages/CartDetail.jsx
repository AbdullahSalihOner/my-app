...
export default function CartDetail() {
  ...
  const removeProduct = async (productId) => {
    ...
    let cartService = new CartService();
    await cartService.deleteFromCart(productId,token).then((result) => setProducts(updatedProducts));
  }
  ...
  const updateQuantity = async (productId, newQuantity) => {
    ...
    let cartService = new CartService();
    await cartService.updateCart(productId,token).then((result) => setProducts(updatedProducts));
  };
      ...
      <div className="row">
        <div className="col-md-8">
          {products.map((product) => (
            <div key={product.product.id} className="mb-3 d-flex justify-content-between align-items-center">
              <div>
                <img src={product.product.imageURL} alt="resim" style={{width:"400px"}} ></img>
        ...
        <div className="col-md-4">
          <div className="card">
            <div className="card-body">
              <h4>Toplam Fiyat: ${calculateTotalPrice()}</h4>
